...
begin
  DBGrid_resultadoPesquisa.Columns[0].FieldName := 'Código';
  DBGrid_resultadoPesquisa.Columns[1].FieldName := 'Descrição';
  ...
  DBGrid_resultadoPesquisa.Columns[7].FieldName := 'Usuário';
end;
...
begin
   sql := 'SELECT ' +
		    'prod_id_produto AS Código,'+
        'prod_desc AS Descrição, '+
